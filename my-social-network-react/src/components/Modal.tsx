  ...
  return (
    <div className={modalState ? 'modal-open' : 'modal'}>
      <div className='modal-content'>
        <span onClick={closeFunction} className='close-button' id='closeModalBtn'>
          &times;
        </span>
        ...
        <form className='modal-form' id='profileForm' onSubmit={submitFunction} noValidate>
          ...
          <div className='modal-buttons'>
            {submitButton ? (
              ...
              <button type='button' onClick={actionFunction} className='modal-button'>
                {leftButton}
              </button>
            )}
            {rightButton && (
              <button type={submitButton ? 'submit' : 'button'} className='modal-button'>
                {rightButton}
              </button>
            )}
          </div>
